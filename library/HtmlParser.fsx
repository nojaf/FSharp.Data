...
val results : HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="sAgDHKHKcf9M6caT7wYQFg">(function(){
...
val links : (string * string) list =
  [("Google", "/?sa=X&ved=0ahUKEwiz-r6Rj-f3AhXXmHIEHWgODCIQOwgC");
   ("Google",
    "/?output=search&ie=UTF-8&sa=X&ved=0ahUKEwiz-r6Rj-f3AhXXmHIEHWgODCIQPAgE");
   ("here", "/search?q=FSharp.Data&ie=UTF-8&gbv=1&sei=PeODYvPnONexytMP6JywkAI");
   ("News",
